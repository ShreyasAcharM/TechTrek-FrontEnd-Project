...
const Footer = () =>{
    ...
    return (
        ...
        <footer className="w-full gradient-border border rounded-t-3xl px-20 border-gray-600 text-gray-700 bg-gradient-to-r from-slate-900 to-slate-700  body-font ">
            <div
                className="container flex flex-col   flex-wrap px-5 md:py-24 py-10 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
                ...
                <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                    ...
                    <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                        <h2 className="mb-3 text-sm font-medium tracking-widest text-[#00df9A] uppercase title-font">Support</h2>
                    ...
                    <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                        <h2 className="mb-3 text-sm font-medium tracking-widest text-[#00df9A] uppercase title-font">Platform
                        </h2>
                        <nav className="mb-10 list-none">
                            <li className="mt-3">
                    ...
                    <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                        <h2 className="mb-3 text-sm font-medium tracking-widest text-[#00df9A] uppercase title-font">Contact</h2>
                        <nav className="mb-10 list-none">
                            <li className="mt-3">
